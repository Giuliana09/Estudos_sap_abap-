...
* [`ZEXERCICIO_001.abap`](src/ZEXERCICIO_001.abap) — **Calculadora de Desconto com Validação:** Aplicação prática combinando `PARAMETERS` obrigatórios (`OBLIGATORY`), validação com mensagem de aviso (`DISPLAY LIKE 'W'`) e cálculo de porcentagem condicional.
